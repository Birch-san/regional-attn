...
if use_consistency_decoder:
  ...
  vae.enable_slicing()
  vae_attn_impl: Literal['natten', 'null', 'original'] = 'natten'
  match(vae_attn_impl):
    case 'natten':
      fuse_vae_qkv(vae)
...
# prompt: str = 'ancient text, book, highly intricate, lonely, breathtaking, 4k, dslr, cinematic, global illumination'
...
prompt: str = 'photo of powerful, elegant woman'
prompts: List[str] = [

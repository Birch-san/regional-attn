...
negative_prompt: Optional[str] = 'blurry, low quality, unfinished, ugly, boring, rough sketch'
prompt: str = 'illustration of sakura tree in full bloom, petals falling, reflected in a pond in the rain at sunset, masterpiece, oil on canvas, highly intricate'
prompts: List[str] = [
